...
class Password extends FormzInput<String, PasswordError> {
  ...
  static final RegExp passwordRegExpNumber = RegExp(r'^(?=.*\d).+$');
  ...
  static final RegExp passwordRegExpSpecial = RegExp(r'^(?=.*[^\w\s]).+$');
  ...
  String? get errorMessage {
    ...
    if (displayError == PasswordError.length) return 'Mínimo 4 caracteres';
